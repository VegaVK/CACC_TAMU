...
# ============== Information ==========================================
# Project:      CACC Research
# Description:  Publishing Desired Acceleration for CACC
...
class ACC:
    def __init__(self):
        ...
        self.accpub=rospy.Publisher('/XACC/Acceleration',Float32,queue_size=1) # Publishing Desired Acceleration of the Car
        # ROS Subscribers
